...
The live chat surface: a single floating panel (compact corner + full-window modes) opened from the launcher and the chatbot section, with an acceptance-by-use privacy notice, transcript download, and resilient fallbacks.
