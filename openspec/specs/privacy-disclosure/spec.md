...
The `/privacy` page and its truthful disclosure of what the site collects (analytics + chat logs), the processors involved, transfers, and the visitor's rights — linked from the in-chat notice.
