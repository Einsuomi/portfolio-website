...
The Writes section — Tong's engineering-judgment case studies as a vertical, text-forward editorial list,
deliberately distinct from the horizontal Projects gallery and extensible as more pieces are written.
...
Security Code Because the Threat Didn't Exist", each with its title and a one-line summary, and a link to
read the full piece.
