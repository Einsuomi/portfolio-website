...
The cross-cutting design-system rules that govern the whole site's look: the serif/condensed typographic
duality and its beat-to-voice mapping, the scarcity rule for the gold accent, and how cards sit over the
